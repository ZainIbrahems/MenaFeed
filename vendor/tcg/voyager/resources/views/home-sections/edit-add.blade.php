...
@section('javascript')
    <script>
        ...
        function updateDesign() {
            var home_section_type = $('select[name="home_section_type"]').val();
            var data = [];
            if(home_section_type=='categories'){
                data = [
            ...
            }else if(home_section_type=='banner'){
                data = [
                    {id: '1_1', text: '1*1'},
                    {id: '2_1', text: '2*1'},
                    {id: '3_1', text: '3*1'},
            ...
            $('select[name="design"]').empty();
            var $element = $('select[name="design"]').select2();
        ...
        $('select[name="home_section_type"]').change(() => {
            updateDesign();
        });
