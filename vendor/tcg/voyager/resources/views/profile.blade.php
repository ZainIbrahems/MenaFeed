...
@section('content')
    ...
    <div style="position:relative; z-index:9; text-align:center;">
        <img src="@if( !filter_var(Auth::user()->personal_picture, FILTER_VALIDATE_URL)){{ Voyager::image( Auth::user()->personal_picture ) }}@else{{ Auth::user()->personal_picture }}@endif"
             class="personal_picture"
             style="border-radius:50%; width:150px; height:150px; border:5px solid #fff;"
             alt="{{ Auth::user()->name }} personal_picture">
