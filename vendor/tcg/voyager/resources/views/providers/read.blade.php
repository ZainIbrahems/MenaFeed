    ...
    <div class="page-content read container-fluid">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="panel panel-bordered" style="padding:5px 20px;">
                    <!-- form start -->
        ...
        <div class="col-md-4">
            ...
            <div class="panel panel-bordered" style="padding-bottom:5px;">
                ...
                <div class="panel-heading" style="border-bottom:0;">
                    ...
                    <h3 class="panel-title">Platform Fields</h3>
                    @php
                        $fields = \App\Models\PlatformUserInput::where('platform_id',$dataTypeContent->{'platform_id'})->get();
                    @endphp

                    @foreach($fields as $field)
                        @php($uf = \App\Models\UsersField::where([
                             'field_id' => $field->id,
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            @if($uf&& $uf->value!=NULL)
                                @if($field->type=='file')
                                    @if(!is_image($uf->value))
                                        <a target="_blank" download=""
                                           href="{{Voyager::image($uf->value)}}">Download</a>
                                    @else
                                        <a target="_blank" download="" href="{{Voyager::image($uf->value)}}">
                                            <img src="{{Voyager::image($uf->value)}}" width="150px;">
                                        </a>
                                    @endif
                                @else
                                    {{$uf->value}}
