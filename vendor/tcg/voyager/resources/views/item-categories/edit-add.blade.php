...
@section('javascript')
    ...
    function updatePlatformId() {
        ...
        $.getJSON("{{route('update-category-market-place')}}/" + platform_id, function (data) {
            $('select[name="platform_category_id"]').empty();
            var $element = $('select[name="platform_category_id"]').select2();
