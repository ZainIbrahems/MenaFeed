...
@section('javascript')
    <script>
        function updateSelect2() {
            var URL = '{{route("platform_categories")}}/' + $('select[name="platform_id"]').val();
            $('select[name="platform_category_id"]').attr('data-get-items-route',URL);
            $('select[name="platform_category_id"]').select2({
                createTag: function () {
                    // Disable tagging
                    return null;
                },
        ...
        $('select[name="platform_id"]').change(() => {
            $('select[name="platform_category_id"]').empty().append(new Option()).trigger('change');
            updateSelect2();
        });
        setTimeout(() => {
            updateSelect2();
