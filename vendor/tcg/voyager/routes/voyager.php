...
Route::group(['as' => 'voyager.'], function () {
    ...
    Route::get('forget-password', ['uses' => $namespacePrefix . 'VoyagerAuthController@forget_password', 'as' => 'forget_password']);
    Route::post('forget-password', ['uses' => $namespacePrefix . 'VoyagerAuthController@postforget_password', 'as' => 'postforget_password']);
    Route::get('reset-password', ['uses' => $namespacePrefix . 'VoyagerAuthController@reset_password', 'as' => 'reset_password']);
    Route::post('reset-password', ['uses' => $namespacePrefix . 'VoyagerAuthController@postreset_password', 'as' => 'postreset_password']);
    ...
    Route::group(['middleware' => 'admin.user'], function () use ($namespacePrefix) {
        ...
        try {
            foreach (Voyager::model('DataType')::all() as $dataType) {
                ...
                Route::get($dataType->slug . '/add-form', $breadController . '@createForm')->name($dataType->slug . '.add-form');
