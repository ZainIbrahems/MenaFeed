...
//            if (request()->has('u_t') && strlen(request()->get('u_t')) > 0 && (request()->get('u_t') == 'client' || request()->get('u_t') == 'provider')) {
//                $query->whereIn('role_id', [getRoleID(request()->get('u_t'))]);
//            } else {
//                $query->whereNotIn('role_id', [getRoleID('client'), getRoleID('provider')]);
//            }
    ...
    public function store(Request $request)
    {
        ...
        $request->merge(array('email' => ($request->email?$request->email:(slugify($request->full_name).'@menaplatforms.com'))));
