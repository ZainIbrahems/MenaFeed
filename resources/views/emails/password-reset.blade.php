        ...
        <tr>
            <td>
                <table width="600" align="center" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr><td><p>We've received a request to reset your password for your Mena account. To proceed, please use the following OTP:</p></td></tr>
                        <tr><td><p style="font-weight:bold;text-align:center;">OPT Code: {{$token}}</p></td></tr>
                        <tr><td><p>Please make sure to enter this code on the password reset page within the next 30 minutes. If you didn't request a password reset, please disregard this email.</p></td></tr>
                        <tr><td><p>If you have any questions or need assistance, please don't hesitate to contact our support team</p></td></tr>
