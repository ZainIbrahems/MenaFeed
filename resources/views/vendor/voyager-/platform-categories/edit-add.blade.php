...
@section('javascript')
    <script>
        ...
        function updatePlatformId() {
            ...
            $.getJSON("{{route('update-category-home-sections')}}/" + platform_id, function (data) {
                $('select[name="platform_category_belongstomany_home_section_relationship[]"]').empty();
                var $element = $('select[name="platform_category_belongstomany_home_section_relationship[]"]').select2();
