                                                ...
                                                @elseif($row->type == 'file' && !empty($data->{$row->field}) )
                                                    ...
                                                    @if(json_decode($data->{$row->field}) !== null)
                                                        @foreach(json_decode($data->{$row->field}) as $file)
                                                            @if(property_exists($file,'download_link'))
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        @foreach(\App\Models\Platform::get() as $platform)
                            <li class="platform">{{$platform->name}} platform</li>
                            <ul>
                                @foreach(\App\Models\BlogsCategory::
                                        where('platform_id',$platform->id)->
                                        where('parent_id',NULL)->get() as $cat)
                                    <li class="parent">{{$cat->title}}</li>
                                    <ul>
