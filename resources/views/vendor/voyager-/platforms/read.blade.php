...
@section('content')
    <div class="page-content read container-fluid">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    <h3 class="panel-title">Addidional Inputs <a target="_blank" class="btn btn-success read-btn" href="{{route('voyager.platform-user-inputs.create',['platform_id'=>$dataTypeContent->getKey()])}}"><i class="voyager-plus"></i></a></h3>
                    <table class="table table-hover">
                        ...
                        @foreach(\App\Models\PlatformUserInput::where('platform_id',$dataTypeContent->getKey())->get() as $input)
                            <tr>
                                ...
                                <td>{{$input->type}}</td>
                                <td>
                                    <a target="_blank" class="btn btn-primary read-btn" href="{{route('voyager.platform-user-inputs.edit',['id'=>$input->id])}}"><i class="glyphicon glyphicon-pencil"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
