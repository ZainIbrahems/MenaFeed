...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            ...
                                            <div class="lecture-btn">
                                                <a href="<?= '../live/' . $data->{'code'} ?>"
                                                   data-meetingId="{{ ($data->{'id'})}}"
                                                   class="btn btn-sm btn-success meetingStart">Start</a>
                                                <a href="#" class="btn btn-sm btn-success invite"
                                                   data-meetingId="{{ ($data->{'id'})}}"
                                                   data-id="<?= 'live/' . $data->{'id'} ?>">Invite</a>
                                                <a href="#" class="btn btn-sm btn-success copy"
                                                   data-meetingId="{{ ($data->{'id'})}}"
                                                   data-meetingHref="<?= '../live/' . $data->{'code'} ?>"
                                                   data-id="<?= 'live/' . $data->{'id'} ?>">Copy Link</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
    ...
    <div class="modal fade" tabindex="-1" id="showInvites" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12" style="margin-bottom: 0;">
                            <form id="inviteForm">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <input type="email" id="inviteEmail" class="form-control mb-2 mr-sm-2"
                                               name="email"
                                               placeholder="Enter an email" maxlength="50" required/>
                                    </div>
                                    <div class="col-lg-3 col-md-3">
                                        <button type="submit" style="margin: 0;" class="btn btn-primary">Invite</button>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <ul class="list-group list-group-flush invite-list" id="invite-list"></ul>
                                </div>
                            </div>
                        </div>
                    </div>
