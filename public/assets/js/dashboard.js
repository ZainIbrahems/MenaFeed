...
$('.copy').on('click', function (e) {
    e.preventDefault();
    let link = (url + '/' + $(this).attr('data-meetingHref')).replace('../','');
...
$('.invite').on('click', function () {
    ...
    $('#inviteId').val($(this).attr('data-meetingId'));
    $.ajax({
        url: url + '/get-invites',
        data: {
            id: $(this).attr('data-meetingId'),
        },
    })
        .done(function (data) {
            data = JSON.parse(data);
